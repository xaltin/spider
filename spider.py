...
class App(Frame):
    def __init__(self,mw):
        self.headers = {'User-Agent':'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.152 Safari/537.36'}
        self.enctype = 'utf-8'
        self.proxies = []
...
<tr\s+?class[^>]*?>\s*?
    ...
    <td>.*?</td>\s*?
        ...
        self.btnExit = Button(self.frmButton,text="退 出",command=sys.exit)    #退出
